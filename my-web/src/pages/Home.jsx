...
<div class='text-center p-4 m-2'>
	...
	<div class='flex justify-center items-center'>
		...
		<h1 class='text-[1.6rem] font-bold tablet:text-3xl laptop:text-4xl'>Formación Académica</h1>
	</div>

		<h2 class='text-[1.3rem] p-4 font-semibold list-item list-inside tablet:text-2xl laptop:text-3xl'>Universidad de Vigo
		<p class='italic'> Máster en Energía y Sostenibilidad (2023)</p>
		</h2>
		 <h2 class='text-[1.3rem] p-4 font-semibold list-item list-inside tablet:text-2xl laptop:text-3xl'>Universidad de Costa Rica
...
<div class='text-center p-4 m-2'>
	...
	<div class='flex justify-center items-center'>
		...
		<h1 class= 'text-[1.6rem] font-bold tablet:text-3xl laptop:text-4xl'>Experiencia Profesional</h1>
	</div>
	
{/* <!-- Edit Experience  --> */}
	
		<h2 class='text-xl m-5 font-semibold tablet:text-2xl laptop:text-3xl'> Ingeniero Interno en Voltfer 
	...
	<div class='text-primary-600 text-center p-4 m-2'>
		<h2 class='text-xl m-5 font-semibold tablet:text-2xl laptop:text-3xl'> Process Lead, Data Management en Amazon
	...
	<div class='text-primary-600 text-center p-4 m-2'>
			<h2 class='text-xl m-5 font-semibold tablet:text-2xl laptop:text-3xl'> Sr. Associate, Data Management en Amazon
	...
	{/* <!-- #4 --> */}
	<div class='text-primary-600 text-center p-4 m-2'>
		<h2 class='text-xl m-5 font-semibold tablet:text-2xl laptop:text-3xl'>Asistente de Laboratorio de Química – Universidad de Costa Rica
...
<div class='text-primary-600 text-center p-4 m-2'>
                ...
                <div>
					...
					<div class='list-item list-inside p-2'>Mejora Continua: Apasionado por optimizar procesos para maximizar la productividad.</div>
					<div class='list-item list-inside p-2'>Servicio al Cliente Excepcional: Comprometido con brindar un servicio superior a través de soluciones personalizadas.</div>
					<div class='list-item list-inside p-2'>Gestión Efectiva de Proyectos: Competente en supervisar proyectos desde su inicio hasta su finalización.</div>
					<div class='list-item list-inside p-2'>Innovación Tecnológica: Entusiasta en integrar tecnología de vanguardia para mejorar operaciones.</div>
					<div class='list-item list-inside p-2'>Cumplimiento Normativo: Diligente en asegurar el cumplimiento de regulaciones y estándares de la industria.</div>
					<div class='list-item list-inside p-2'>Aprendizaje Permanente: Comprometido con el desarrollo profesional continuo y el crecimiento.</div>
					<div class='list-item list-inside p-2'>Planificación Estratégica: Enfocado en iniciativas estratégicas para impulsar el éxito organizacional.</div>
					<div class='list-item list-inside p-2'>Responsabilidad Social Corporativa (RSC): Comprometido con apoyar iniciativas de RSC mediante prácticas efectivas de gestión de datos, contribuyendo a los objetivos de sostenibilidad corporativa y de impacto social.</div>
					<div class='list-item list-inside p-2'>Gestión Sostenible de la Cadena de Suministro: Interesado en aplicar principios de gestión de datos para optimizar procesos de la cadena de suministro y mejorar la sostenibilidad en toda la cadena de valor.</div>
					<div class='list-item list-inside p-2'>Energía Renovable: Interesado en aprovechar técnicas de gestión de datos para optimizar sistemas de energía renovable y promover soluciones energéticas sostenibles.</div>
					<div class='list-item list-inside p-2'>Reducción de la Huella de Carbono: Comprometido en utilizar enfoques basados en datos para rastrear y reducir las emisiones de carbono, promoviendo la responsabilidad ambiental y la sostenibilidad.</div>
