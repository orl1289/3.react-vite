...
<section className='b-container m-auto'>
        ...
        <div class='text-primary-600 text-center p-4 m-2'>
            ...
            <div class='flex justify-center items-center'>
                ...
                <h1 class='font-bold text-4xl '>Professional Expererience</h1>
            </div>

            {/* < />!-- Edit Experience  --> */}

            <h2 class='font-semibold text-2xl '> Engineering Intern at Voltfer
            ...
            {/* < />!-- #1 --> */}
            <div class='text-primary-600 text-center p-4 m-2'>
                <h2 class='font-semibold text-2xl '> Team Manager, Data Management at Amazon
            ...
            {/* < />!-- #2 --> */}
            <div class='text-primary-600 text-center p-4 m-2'>
                <h2 class='font-semibold text-2xl '> Process Lead, Data Management at Amazon
            ...
            {/* < />!-- #3 --> */}
            <div class='text-primary-600 text-center p-4 m-2'>
                <h2 class='font-semibold text-2xl '> Sr. Associate, Data Management at Amazon
            ...
            {/* < />!-- #4 --> */}
            <div class='text-primary-600 text-center p-4 m-2'>
                <h2 class='font-semibold text-2xl '>Chemistry Laboratory Assistant – University of Costa Rica
            ...
            <div class='text-primary-600 text-center p-4 m-2'>
                ...
                <div>
                    <div class='grid grid-cols-2 p-2 m-2 text-2xl '>
                        <div class='list-item list-inside'>Data Optimization: Dedicated to refining data processes for enhanced efficiency and accuracy</div>
                        <div class='list-item list-inside'>Sustainable Practices: Committed to driving sustainability initiatives to reduce environmental impact.</div>
                        <div class='list-item list-inside'>Collaborative Leadership: Skilled in leading diverse teams to achieve collective goals.</div>
                        <div class='list-item list-inside'>Continuous Improvement: Passionate about streamlining processes to maximize productivity.</div>
                        <div class='list-item list-inside'>Exceptional Customer Service: Committed to delivering superior service through tailored solutions.</div>
                        <div class='list-item list-inside'>Effective Project Management: Proficient in overseeing projects from inception to completion. </div>
                        <div class='list-item list-inside'>Technological Innovation: Enthusiastic about integrating cutting-edge tech for improved operations.</div>
                        <div class='list-item list-inside'>Regulatory Adherence: Diligent in ensuring compliance with industry regulations and standards.</div>
                        <div class='list-item list-inside'>Lifelong Learning: Committed to ongoing professional development and growth.</div>
                        <div class='list-item list-inside'>Strategic Planning: Focused on strategic initiatives to drive organizational success. </div>
                        <div class='list-item list-inside'>Corporate Social Responsibility (CSR): Committed to supporting CSR initiatives through effective data management practices, contributing to corporate sustainability and social impact goals. </div>
                        <div class='list-item list-inside'> Sustainable Supply Chain Management: Interested in applying data management principles to optimize supply chain processes and enhance sustainability throughout the value chain</div>
                        <div class='list-item list-inside'>Renewable Energy: Interested in leveraging data management techniques to optimize renewable energy systems and promote sustainable energy solutions. </div>
                        <div class='list-item list-inside'>Carbon Footprint Reduction: Committed to utilizing data-driven approaches to track and reduce carbon emissions, promoting environmental responsibility and sustainability.</div>
